...
// Let's say we want to find if there is "Second" in the array
// Then the code would be
find_data_from_array(array1, "Second")
// Expected Output : 
/*
Data matched succesfully 
 Found in  1  of array.
*/

// array1 can be replaced by any array and
// "Second" can be replaced by any data that you want to find.
